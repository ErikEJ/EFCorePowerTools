...
namespace ErikEJ.EntityFrameworkCore.SqlServer.Scaffolding
{
    ...
    /// </summary>
    public class SqlServerFasterDatabaseModelFactory : DatabaseModelFactory
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public SqlServerFasterDatabaseModelFactory([NotNull] IDiagnosticsLogger<DbLoggerCategory.Scaffolding> logger)
        {
