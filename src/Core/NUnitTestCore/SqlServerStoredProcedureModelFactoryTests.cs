...
END;";
            ...
            var someName = resultSet.Single(c => c.Name == "SomeName");
            var someValue = resultSet.Single(c => c.Name == "SomeValue");
...
END;";
            ...
            var categoryId = resultSet.Single(c => c.Name == "CategoryId");
            var searchTerm = resultSet.Single(c => c.Name == "SearchTerm");
            var amount = resultSet.Single(c => c.Name == "Amount");
            ...
            Assert.Equal((short?)10, amount.Precision);
            Assert.Equal((short?)2, amount.Scale);
...
END;";
            ...
            Assert.Equal(["CategoryId", "TotalCount"], resultSets[0].Select(c => c.Name));
            Assert.Equal(["CategoryId", "ItemName"], resultSets[1].Select(c => c.Name));
...
END;";
            ...
            var objectName = Assert.Single(resultSet);
