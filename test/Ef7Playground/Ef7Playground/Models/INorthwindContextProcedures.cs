...
namespace Ef7Playground.Models
{
    public partial interface INorthwindContextProcedures
    {
        ...
        Task<List<EmployeeSalesbyCountryResult>> EmployeeSalesbyCountryAsync(DateTime? BeginningDate, DateTime? EndingDate, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        ...
        Task<List<SalesbyYearResult>> SalesbyYearAsync(DateTime? BeginningDate, DateTime? EndingDate, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
