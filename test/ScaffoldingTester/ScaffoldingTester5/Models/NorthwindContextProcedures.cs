...
namespace ScaffoldingTester.Models
{
    ...
    public partial class NorthwindContextProcedures
    {
        ...
        public virtual async Task<(List<MultiSetResult1> MultiSetResults1, List<MultiSetResult2> MultiSetResults2, List<MultiSetResult3> MultiSetResults3)> MultiSetAsync(DateTime? Year, decimal? ProductValue, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            (List<MultiSetResult1> r1, List<MultiSetResult2> r2, List<MultiSetResult3> r3) _;
