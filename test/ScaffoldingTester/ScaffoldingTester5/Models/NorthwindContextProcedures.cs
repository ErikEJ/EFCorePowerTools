...
namespace ScaffoldingTester.Models
{
    ...
    public partial class NorthwindContextProcedures
    {
        ...
        public virtual async Task<(List<MultiSetResult1> Result1, List<MultiSetResult2> Result2, List<MultiSetResult3> Result3)> MultiSetAsync(DateTime? Year, decimal? ProductValue, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
